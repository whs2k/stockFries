...
$(this).remove();
$('.icon-pencil').show();
var root_path = document.location.origin;
var task = 'edit';
var company_random_id = id;
var value = newcontent;
$.post(root_path+'/company_add.php',{company_random_id:company_random_id,task:task,value:value},function(data){
...
$.post(root_path+'/company_add.php',{company_random_id:company_random_id,task:task},function(data){
...
$.post(root_path+'/company_add.php',{task:task},function(data){
